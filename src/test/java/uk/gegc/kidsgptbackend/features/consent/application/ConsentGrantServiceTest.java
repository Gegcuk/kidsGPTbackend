...
class ConsentGrantServiceTest extends ConsentServiceBaseTest {
    ...
    void grantConsent_ShouldResolveVerificationMethod() {
        // Arrange
        uk.gegc.kidsgptbackend.features.consent.domain.model.ParentVerification verification = uk.gegc.kidsgptbackend.features.consent.domain.model.ParentVerification.builder()
