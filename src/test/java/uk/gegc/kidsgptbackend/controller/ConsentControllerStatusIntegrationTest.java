...
class ConsentControllerStatusIntegrationTest {
    ...
    void emptyStatusNoConsents_returns200WithReconsentNeededTrue() throws Exception {
        ...
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse emptyResponse = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse(
    ...
    void populatedStatusAllCurrent_returns200WithReconsentNeededFalse() throws Exception {
        ...
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse.ConsentStatusByType entry1 = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse.ConsentStatusByType(
                uk.gegc.kidsgptbackend.model.consent.ConsentType.PRIVACY_POLICY,
                "1.2.3",
                uk.gegc.kidsgptbackend.model.consent.ConsentStatus.GRANTED,
                java.time.LocalDateTime.now(),
                "https://kidsgpt.club/policies/privacy/en-GB"
            );
        
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse.ConsentStatusByType entry2 = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse.ConsentStatusByType(
                uk.gegc.kidsgptbackend.model.consent.ConsentType.TERMS_OF_SERVICE,
                "2.0.0",
                uk.gegc.kidsgptbackend.model.consent.ConsentStatus.GRANTED,
                java.time.LocalDateTime.now(),
        ...
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse populatedResponse = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse(
    ...
    void includesMostRecentConsentId() throws Exception {
        ...
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse responseWithSpecificConsentId = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse(
                List.of(), // empty latestByType array
                true,      // reconsentNeeded = true
    ...
    void contentTypes() throws Exception {
        ...
        uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse successResponse = 
            new uk.gegc.kidsgptbackend.dto.consent.ConsentStatusResponse(
                List.of(), // empty latestByType array
                true,      // reconsentNeeded = true
                null       // consentId = null
